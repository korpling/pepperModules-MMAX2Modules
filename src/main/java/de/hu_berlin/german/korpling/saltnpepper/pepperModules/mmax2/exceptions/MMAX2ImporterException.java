...
public class MMAX2ImporterException extends PepperModuleException {
	...
	private static final String STD_MSG= "This exception was thrown by the MMAX2Importer: "; 
	public MMAX2ImporterException()
	{ super(); }
	
    public MMAX2ImporterException(String s)
    { super(STD_MSG+ s); }
    
	public MMAX2ImporterException(String s, Throwable ex)
	{super(STD_MSG+s, ex); }
}

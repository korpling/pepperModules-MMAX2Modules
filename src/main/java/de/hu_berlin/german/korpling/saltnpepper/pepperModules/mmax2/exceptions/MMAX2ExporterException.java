...
public class MMAX2ExporterException extends PepperModuleException {
	...
	private static final String STD_MSG= "This exception was thrown by the MMAX2Exporter: "; 
	public MMAX2ExporterException()
	{ super(); }
	
    public MMAX2ExporterException(String s)
    { super(STD_MSG+ s); }
    
	public MMAX2ExporterException(String s, Throwable ex)
	{super(STD_MSG+s, ex); }
}
